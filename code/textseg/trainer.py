...
def build_config(
    ...
    cfg.MODEL.ROI_HEADS.SCORE_THRESH_TEST = proj_config['detectron2'].getfloat('prediction_score_threshold')
    cfg.SOLVER.IMS_PER_BATCH = proj_config['detectron2'].getint('im_batch_size')
    ...
    cfg.MODEL.ROI_HEADS.BATCH_SIZE_PER_IMAGE = proj_config['detectron2'].getint('roi_batch_size')
